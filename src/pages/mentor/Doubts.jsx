          ...
          {detailLoading ? (
            ...
            <div className="bg-white dark-theme:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6 border-b dark-theme:border-gray-700">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-2 text-sm text-gray-500 dark-theme:text-gray-400 flex-wrap">
                ...
                {selectedDoubt.description && (
                  <p className="mt-3 text-gray-600 dark-theme:text-gray-300 whitespace-pre-wrap">{selectedDoubt.description}</p>
                )}
                <div className="mt-3 flex items-center gap-3 text-sm text-gray-500 dark-theme:text-gray-400 flex-wrap">
                  {selectedDoubt.mentorName && (
                    <span className="bg-blue-50 dark-theme:bg-blue-900/20 text-blue-700 dark-theme:text-blue-300 px-2 py-0.5 rounded text-xs">
                      <i className="ri-user-star-line mr-1"></i>Assigned: {selectedDoubt.mentorName}
                    </span>
                  )}
                  {!selectedDoubt.assignedMentorId && (
                    <span className="bg-amber-50 dark-theme:bg-amber-900/20 text-amber-700 dark-theme:text-amber-300 px-2 py-0.5 rounded text-xs font-medium animate-pulse">
              ...
              {selectedDoubt.status !== 'resolved' && selectedDoubt.status !== 'closed' && (
                <div className="p-4 border-t dark-theme:border-gray-700">
