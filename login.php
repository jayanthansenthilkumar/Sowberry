...
<head>
    ...
    <title>Login & Register - Sowberry</title>
    ...
    <style>
        ...
        /* Ensure all form groups have consistent height */
        .form-group {
            min-height: 42px;
            margin-bottom: 1rem;
        }
...
<body>
    ...
    <div class="split-container">
        ...
        <div class="brand-side">
            <div id="particles-left" class="particles"></div>
            <div class="brand-content">
                <div class="brand-logo">
                    <i class="ri-seedling-fill"></i>
                </div>
                <h1>Sowberry</h1>
                <p class="tagline">Grow your skills, bloom your future</p>
            </div>
            <!-- Background shapes -->
        ...
        <div class="forms-side">
            <div id="particles-right" class="particles"></div>
                ...
                <div class="forms-container">
                    ...
                    <div class="form-section login-section active">
                        ...
                        <div class="login-form">
                            ...
                            <p class="switch-form-link">
                                Don't have an account? <a href="#" onclick="toggleForms('register')">Sign up</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="form-section register-section">
                        ...
                        <div class="login-form">
                            ...
                            <form action="/register" method="POST" id="registerForm" class="compact-form">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="input-wrapper">
                                        <input type="text" id="username" name="username" placeholder="Choose username" required disabled>
                                        <span class="validation-message"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-wrapper">
                                        <input type="text" id="fullName" name="fullName" placeholder="Full name" required disabled>
                                        <span class="validation-message"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-wrapper">
                                        <div class="phone-input-group">
                                            <select class="country-code" id="countryCode" name="countryCode" required disabled>
                                ...
                                <!-- Remove file upload section and go straight to terms -->
                                <div class="form-options">
                                    <label class="terms-checkbox">
                                        <input type="checkbox" name="terms" required disabled>
                                        <span>I agree to the Terms & Conditions</span>
                                    </label>
                                </div>

                                <button type="submit" class="auth-btn" disabled>Create Account</button>
                            </form>
                    ...
                    <div class="form-section forgot-section">
                        <div class="login-header">
                            <i class="ri-seedling-fill"></i>
                            <h1>Sowberry</h1>
                        </div>
                        <div class="login-form">
                            <!-- Step 1: Email/Phone -->
                            <div class="forgot-step step-1 active">
                                <h2>Reset Password</h2>
                                <p>Enter your email to receive OTP</p>
                                
                                <form id="forgotForm" class="compact-form">
                                    <div class="form-group">
                                        <div class="input-wrapper">
                            ...
                            <div class="forgot-step step-2">
                                <h2>Enter OTP</h2>
                                <p>Please enter the OTP sent to your email</p>
                                
                                <form id="otpForm" class="compact-form">
                                    <div class="form-group">
                            ...
                            <!-- Step 3: New Password -->
                            <div class="forgot-step step-3">
                                <h2>Set New Password</h2>
                                <p>Enter your new password</p>
                                
                                <form id="resetPasswordForm" class="compact-form">
                                    <div class="form-group">
                                        <div class="password-input">
                            ...
                            <p class="switch-form-link">
                                Remember your password? <a href="#" onclick="toggleToLogin()">Sign in</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function toggleForms(formType) {
            const sections = {
                ...
                register: document.querySelector('.register-section'), // Fixed 'gister' to 'register'
                forgot: document.querySelector('.forgot-section')
            };
            ...
            if (currentActive) {
                ...
                setTimeout(() => {
                    ...
                    // Show new section
                    const activeSection = sections[formType];
                    if (activeSection) {
                ...
                }, 200); // Reduced from 300ms to 150ms
            } else {
                // If no active section, just show the new one
                const activeSection = sections[formType];
                if (activeSection) {
                    activeSection.classList.add('active');
                    activeSection.style.transform = 'translateX(0)';
        ...
        function initializeParticles() {
            setTimeout(() => {
                try {
                    particlesJS('particles-left', leftConfig);
                    particlesJS('particles-right', rightConfig);
        ...
        function initializeFormValidation() {
            ...
            emailInput.addEventListener('input', function() {
                ...
                if (isValidFormat) {
                    ...
                    if (validTLDs.some(validTLD => tld === validTLD)) {
                        ...
                        validationMsg.setAttribute('title', 'Invalid email domain');
                    }
                } else {
                    disableFollowingInputs('username');
                    showValidation(this, false, '×');
                }
                checkFormValidity();
            });
            ...
            usernameInput.addEventListener('input', function() {
                if (this.value.length >= 3) {
                    ...
                    disableFollowingInputs('fullName');
                    showValidation(this, false);
                }
                checkFormValidity();
            });

            // Update Full Name validation in initializeFormValidation function
            fullNameInput.addEventListener('input', function() {
                if (this.value.length >= 2) {
                    // Enable both country code and phone input simultaneously
            ...
            // Replace the phone validation code
            ...
            // Update checkFormValidity function
            function checkFormValidity() {
                const phoneValue = phoneInput.value.replace(/\D/g, ''); // Remove non-digits
                const isComplete = !emailInput.value.includes(' ') &&
                    usernameInput.value.length >= 3 &&
                    fullNameInput.value.length >= 2 &&
            ...
            // Fix country code change handler
            ...
            // Update showValidation function
            function showValidation(element, isValid, icon) {
                const validationMessage = element.parentElement.querySelector('.validation-message');
                if (validationMessage) {
                    validationMessage.textContent = icon;
                    validationMessage.className = 'validation-message ' + (isValid ? 'valid' : 'invalid');
                    validationMessage.style.animation = 'none';
                    validationMessage.offsetHeight;
                    validationMessage.style.animation = 'popIn 0.3s ease';
                }
            }

            function disableFollowingInputs(startFrom) {
                const inputs = ['username', 'fullName', 'phone'];
                const startIndex = inputs.indexOf(startFrom);
            ...
            document.querySelectorAll('[onclick*="toggleForms"]').forEach(element => {
                element.addEventListener('click', function(e) {
                    e.preventDefault();
                    const formType = this.getAttribute('onclick').match(/'([^']+)'/)[1];
                    toggleForms(formType);
                });
            });

            // Add this to initialize country code change handler
            document.getElementById('countryCode').addEventListener('change', function() {
                const phoneInput = document.getElementById('phone');
                const phoneValue = phoneInput.value.replace(/\D/g, '');
                if (phoneValue.length === 10) {
        ...
        function initializeEventListeners() {
            ...
            // Add this event listener for forgot password link
            document.querySelector('.forgot-password').addEventListener('click', function(e) {
                e.preventDefault();
                toggleForms('forgot');
            });
