...
<head>
    ...
    <title>My Progress - Sowberry</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="#" class="active"><i class="ri-line-chart-line"></i><span>My Progress</span></a>
            ...
            <div class="welcome-card">
                <div class="welcome-content">
                    <div class="welcome-text">
                        <h1>Your Learning <span class="highlight">Progress</span></h1>
            ...
            <div class="card animate">
                ...
                <div class="course-progress-list">
                    ...
                    <div class="course-progress-item">
                        ...
                        <span class="status-badge success">Almost Done</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card animate">
                ...
                <div class="achievements-list">
                    ...
                    <div class="achievement-item">
                        ...
                        <div class="achievement-info">
                            <h4>7-Day Streak</h4>
                            <p>Consistent learning for a week</p>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const learningHoursChart = new Chart(
                document.getElementById('learningHoursChart'),
                {
                    type: 'bar',
                    data: {
