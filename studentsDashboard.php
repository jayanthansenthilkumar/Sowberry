            ...
            <div class="welcome-card">
                <div class="welcome-content">
                    <div class="welcome-text">
                        <h1>Welcome back, <span class="highlight">Sowmiya!</span></h1>
        ...
        <div class="activity-section">
                ...
                <div class="activity-list">
                    <div class="activity-item">
                        ...
                        <div class="activity-info">
                            <p>Completed "JavaScript Basics" lesson</p>
                            <span>1 hour ago</span>
                        </div>
                    </div>
                    <div class="activity-item">
                        ...
                        <div class="activity-info">
                            <p>Submitted assignment: "React Components"</p>
                            <span>3 hours ago</span>
                        </div>
                    </div>
                    <div class="activity-item">
            ...
            <div class="card animate">
                ...
                <div class="task-list">
                    ...
                    <div class="task-item">
                        <div class="task-info">
                            <h4>UI/UX Project Submission</h4>
                            <p>Due in 5 days</p>
                        </div>
