...
// Create student-specific charts
function createStudentCharts() {
    ...
    new Chart(gradesCtx, {
        type: 'bar',
        data: {
            labels: ['Math', 'Physics', 'Programming', 'English', 'History'],
            datasets: [{
                data: [95, 88, 92, 85, 90],
    ...
    new Chart(tasksCtx, {
        type: 'doughnut',
        data: {
            labels: ['Completed', 'Due Soon', 'Upcoming'],
            datasets: [{
                data: [12, 4, 6],
...
document.addEventListener('DOMContentLoaded', () => {
    createStudentCharts();
    // ...existing code for theme toggle and other functionality...
});
