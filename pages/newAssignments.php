...
<body>
    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="#" class="active"><i class="ri-award-line"></i><span>Assignments</span></a>
    ...
    <main>
            ...
            <div class="welcome-card">
                <div class="welcome-content">
                    <div class="welcome-text">
                        <h1>Assignments <span class="highlight">Management</span></h1>
        ...
        <div class="list-card">
            <div class="list-header">
                ...
                <button class="action-button" id="addAssignmentBtn">
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <!-- Add more assignment rows as needed -->
                    </tbody>
                </table>
            </div>
        </div>
